...
// ── LLM Council Models (21-model roster across 5 tiers) ──
export const MODELS = [
  // Tier 1 — Premium (6)
  ...
  { id: 'x-ai/grok-4.1-fast', name: 'Grok 4.1 Fast', color: '#E5375E', letter: 'Gk', tier: 'efficient', inputPrice: 0.2, outputPrice: 0.5, binaryThinking: true },
  // Tier 4 — Budget (4)
  ...
  { id: 'meta-llama/llama-4-maverick', name: 'Llama 4 Maverick', color: '#C084FC', letter: 'LM', tier: 'budget', inputPrice: 0.2, outputPrice: 0.6 },
  // Tier 5 — Specialist (1)
...
// ── Council Presets (Phase 9) ──
export const COUNCIL_PRESETS = [
  { id: 'quick-test', name: 'Quick Test', category: 'speed',
    icon: 'volt', description: '3 fast models, rapid iteration',
  ...
  { id: 'genesis-classic', name: 'Genesis Classic', category: 'balanced',
    icon: 'signet', description: 'The original 7-soul war room',
  ...
  { id: 'copywriting-lab', name: 'Copywriting Lab', category: 'specialist',
    icon: 'folio', description: '5 master copywriters battle for the best headline',
  ...
  { id: 'design-showdown', name: 'Design Showdown', category: 'specialist',
    icon: 'canvas', description: '6 design legends compete on visual identity',
  ...
  { id: 'boardroom', name: 'The Boardroom', category: 'specialist',
    icon: 'pulse', description: '5 business titans stress-test your strategy',
  ...
  { id: 'brand-launch', name: 'Brand Launch', category: 'use-case',
    icon: 'volt', description: 'Full team for launching a new brand from scratch',
  ...
  { id: 'rebrand', name: 'Rebrand Surgery', category: 'use-case',
    icon: 'focus', description: 'Refresh an existing brand without losing equity',
  ...
  { id: 'viral-campaign', name: 'Viral Campaign', category: 'use-case',
    icon: 'cortex', description: 'Disruptors and provocateurs for maximum impact',
    time: '~20 min', participants: 6,
  ...
  { id: 'product-naming', name: 'Product Naming', category: 'use-case',
    icon: 'prism', description: 'Specialists in memorable verbal identity',
    time: '~12 min', participants: 5,
    souls: ['david-ogilvy', 'leo-burnett', 'paul-rand', 'rob-janoff', 'richard-branson'],
    moderator: 'steve-jobs', evaluator: 'jony-ive',
    daEnabled: false },
  { id: 'full-assembly', name: 'Full Assembly', category: 'maximum',
    icon: 'shield', description: 'All 16 souls — maximum creative coverage',
