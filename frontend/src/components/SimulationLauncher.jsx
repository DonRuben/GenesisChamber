...
const DEFAULT_MODELS = {
  ...
  'gary-halbert': 'x-ai/grok-4.1-fast',                   // $3/$15 — raw, provocative, urgent
  // Design & Visual
  ...
  'rob-janoff': 'x-ai/grok-4.1-fast',                     // $3/$15 — unconventional simplicity
  'tobias-van-schneider': 'google/gemini-3-pro',    // $1.25/$10 — modern, digital-first
  // Business & Strategy
  'elon-musk': 'x-ai/grok-4.1-fast',                      // $3/$15 — HIS OWN AI COMPANY
  ...
  'devils-advocate': 'x-ai/grok-4.1-fast',                 // $3/$15 — provocative, NOT Claude
};
      ...
      const config = {
        ...
        ...(devilsAdvocateActive ? {
          devils_advocate: {
            ...
            model: modelAssignments['devils-advocate'] || 'x-ai/grok-4.1-fast',
            ...
            {devilsAdvocateActive && (
              <div className="da-command-center" style={{
                ...
                <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '10px' }}>
                  {availableModels && (
                    <ModelSelector
                      value={modelAssignments['devils-advocate'] || 'x-ai/grok-4.1-fast'}
